...
import { getEWasteProductsFromServer } from "../Services/ApiServices";
...
export function EWaste() {
  ...
  async function getAllProducts() {
    const response = await getEWasteProductsFromServer();
            ...
            <div className="container-fluid">
              <div
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                    <div
                      className="nav-link  activeSubLink subNavLinks"
                      aria-current="page">
