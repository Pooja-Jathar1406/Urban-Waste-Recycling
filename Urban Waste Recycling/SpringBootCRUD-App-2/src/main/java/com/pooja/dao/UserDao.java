...
//    @Query(value = "select u from user u where u.email= :email and u.mobile=:mobile" )
//    public User findByEmailAndPhone(@Param(value = "email") String email,@Param(value = "mobile") String password);
